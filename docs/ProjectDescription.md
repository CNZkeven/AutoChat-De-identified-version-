...
- Per-agent model credentials: `IDEOLOGICAL_*`, `EVALUATION_*`, `TASK_*`, `EXPLORATION_*`, `COMPETITION_*`, `COURSE_*`
- Memory summary credentials: `SUMMARY_API_KEY`, `SUMMARY_BASE_URL`
